...
import Button_Component from "./Button/Button_Component"; // Import your button component
    ...
    <div
      ...
      {slides.map((slide, index) => (
        <div
          ...
          {/* Slide caption */}
          <div style={styles} className="hidden sm:block absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8 text-white bg_opacity_box">
            <h2 className="text-3xl font-bold mb-2">{slide.title}</h2>
            <p className="text-lg mb-2">{slide.description}</p>

            <div className="flex flex-wrap items-center gap-3">
              <Button_Component
                ActionUrl={slide.movieUrl}
                Title={"Watch Now"}
                BtnType={"gradient"}
              />
            </div>
...
// This code defines a React component that displays a slider with video and image slides.